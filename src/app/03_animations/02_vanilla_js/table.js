// At no point except the start there is a call to creating nodes, still memory leak => build system?
// Refactoring not done since issue...
// Have commented out parts incrementally, but still nodes created, still should be references at most...
...
// Commening out full animate function... Still keeps growing no. of nodes...
...
Table.prototype.render = function(inData){
	...
	// 	// Lookup object that needs to be cleared (i.e. all data needs binding to element) before done
		...
		var update = [];
		// Go through nodes
		// !!! Converted to for loop, no closure => still nodes created...
		...
		// 	}
		// }
		// !!! Commenting out everything below => nodes still grows...
